work_path = "E:\\fyzsimulation\\in\\GAP\\hxy\\3000T1\\" #工作目录
bonds = open(work_path + "bonds.reax","r") #修改文件名
dump = open(work_path + "gaponechain_0Kcalmol_EquNPT_3000T_NVT_bonds_ana.lammpstrj","r") #修改文件名
